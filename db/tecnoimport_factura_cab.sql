...
CREATE TABLE `factura_cab` (
  ...
  `num_cotiza` int(11) DEFAULT NULL,
  `fecha_crea` date DEFAULT NULL,
  `fecha_vence` date DEFAULT NULL,
  `total` float DEFAULT NULL,
  PRIMARY KEY (`num_doc`),
  KEY `num_cot_idx` (`num_cotiza`),
  CONSTRAINT `num_cot` FOREIGN KEY (`num_cotiza`) REFERENCES `coti_cab` (`num_doc`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `factura_cab`
--

LOCK TABLES `factura_cab` WRITE;
/*!40000 ALTER TABLE `factura_cab` DISABLE KEYS */;
/*!40000 ALTER TABLE `factura_cab` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-08-18 21:26:52
