...
CREATE TABLE `factura_det` (
  ...
  PRIMARY KEY (`num_doc`),
  KEY `cod_item_idx` (`cod_item`),
  KEY `cod_bode_idx` (`cod_bodega`),
  CONSTRAINT `cod_bode` FOREIGN KEY (`cod_bodega`) REFERENCES `bodegas` (`cod_bodega`) ON UPDATE CASCADE,
  CONSTRAINT `cod_item` FOREIGN KEY (`cod_item`) REFERENCES `items` (`cod_item`)
...
-- Dump completed on 2019-08-18 21:27:00
